  ...
  <section class="section_app_blog_papyrist">
    ...
    <section class="section_content_blog_papyrist">
      <section class="section_posts_content_blog_papyrist">
        <?php
        $query = "SELECT * FROM `posts` WHERE StatusPost = 1";
        ...
        ?>
          <section class="section_post_section_posts_content_blog_papyrist">
            <a href="./Pages/Post/Post.php?PostId=<?= $post->Id ?>">
            ...
            <a href="./Pages/Post/Post.php?PostId=<?= $post->Id ?>" class="text_title_section_post_section_posts_content_blog_papyrist">
              <?= $post->TitlePost ?>
            </a>
            ...
            <section class="section_button_section_post_section_posts_content_blog_papyrist">
              <a href="./Pages/Post/Post.php?PostId=<?= $post->Id ?>">Read More</a>
            </section>
          </section>
        <?php } ?>
      </section>
